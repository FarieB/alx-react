...
describe('Normalized Data Tests', () => {
  it('should verify the normalized data has a correct result array', () => {
  ...
  it('should verify the normalized data has a correct users entity', () => {
  ...
  it('should verify the normalized data has a correct messages entity', () => {
  ...
  it('should verify the normalized data has a correct notifications entity', () => {
