...
import { LOGIN, LOGOUT, DISPLAY_NOTIFICATION_DRAWER } from "../actions/uiActionTypes";
...
describe("uiReducer tests", function () {
  ...
  it("verifies the state returned by the uiReducer function, when the action LOGOUT is passed, clears the user property", function () {
    let state = uiReducer(undefined, { type: LOGIN, user: USER });
